...
- 2.за зеленый цвет отвечают следующие два символы AB. Переводим в десятичную систему:  AB~16~ = 171~10~
 
- 3. за синий отвечают последние два символа F0. Переводим в десятичную систему:  F0~16~ = 240~10~
